...
3.  Navigate to "Database" and click "Create Database".
    <Image
      ...
      src={`/images/real-time-post-views/firebase/step1.webp`}
      width={1000}
      height={534}
    />
4.  Start in test mode and click next.
    <Image
      alt={`Create Firebase Database`}
      src={`/images/real-time-post-views/firebase/step2.webp`}
      width={1000}
      height={533}
    />
5.  Choose your database location and click done.
    <Image
      alt={`Create Firebase Database`}
      src={`/images/real-time-post-views/firebase/step3.webp`}
      width={1000}
      height={532}
    />
6.  In the top left, click on "Project Settings".
    <Image
      alt={`Create Firebase Database`}
      src={`/images/real-time-post-views/firebase/step4.webp`}
      width={979}
      height={386}
    />
7.  Navigate to "Service Accounts" tab and click "Generate new private key". Save the `.json` file. You will need this later.
    <Image
      alt={`Create Firebase Database`}
      src={`/images/real-time-post-views/firebase/step5.webp`}
      width={1000}
      height={535}
    />
...
<Image
  ...
  src={`/images/real-time-post-views/testing-database.webp`}
  width={1000}
  height={562}
/>
...
You can view a completed example by checking out [this blog post's source code](https://github.com/leerob/arifin.xyz).
I was able to migrate my page views from Google Analytics into Firebase via their web interface.

<Image
  alt={`Blog Post Views`}
  src={`/images/real-time-post-views/blog-post-views.webp`}
  width={1000}
  height={599}
/>
...
<Image
  alt={`Database Usage`}
  src={`/images/real-time-post-views/db-usage.webp`}
  width={1000}
  height={529}
/>
