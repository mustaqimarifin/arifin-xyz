...
image: '/images/style-guides-component-libraries-design-systems/banner.webp'
---
...
<a aria-label="Website Mockup" href="https://refactoringui.com/">
  <Image
    alt={`Website Mockup`}
    src={`/images/style-guides-component-libraries-design-systems/website.webp`}
    width={1467}
    height={878}
  />
</a>
...
>
  <Image
    alt={`Style Guide`}
    src={`/images/style-guides-component-libraries-design-systems/style-guide.webp`}
    width={1468}
    height={1101}
  />
</a>
...
<a aria-label="Component Library" href="https://eva.design/">
  <Image
    ...
    src={`/images/style-guides-component-libraries-design-systems/components.webp`}
    width={1000}
    height={376}
  />
</a>
...
>
  <Image
    alt={`Design System`}
    src={`/images/style-guides-component-libraries-design-systems/design-system.webp`}
    width={1400}
    height={900}
  />
</a>
...
<a aria-label="Design Tokens" href="https://www.antforfigma.com/">
  <Image
    alt={`Design Tokens`}
    src={`/images/style-guides-component-libraries-design-systems/design-tokens.webp`}
    width={1080}
    height={810}
  />
</a>
...
>
  <Image
    alt={`Icon set`}
    src={`/images/style-guides-component-libraries-design-systems/icons.webp`}
    width={800}
    height={600}
  />
</a>
...
>
  <Image
    alt={`Monorepo`}
    src={`/images/style-guides-component-libraries-design-systems/monorepo.webp`}
    width={1467}
    height={583}
  />
</a>
...
<a aria-label="Buttons" href="https://eva.design/">
  <Image
    alt={`Buttons`}
    src={`/images/style-guides-component-libraries-design-systems/buttons.webp`}
    width={1000}
    height={641}
  />
</a>
