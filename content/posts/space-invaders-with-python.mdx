...
<Image
  alt={`Space Invaders`}
  src={`/images/space-invaders-with-python/space-invaders.webp`}
  width={795}
  height={620}
/>
...
- [Sprite Sheet](https://orig02.deviantart.net/3ed1/f/2009/242/f/4/space_invaders_sprite_sheet_by_gooperblooper22.webp)
