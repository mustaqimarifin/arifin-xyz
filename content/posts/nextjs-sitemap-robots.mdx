...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
      <loc>https://arifin.xyz</loc>
  </url>
  <url>
      <loc>https://arifin.xyz/blog</loc>
  </url>
</urlset>
```
...
> **Note:** `globby` [might not work](https://github.com/leerob/arifin.xyz/issues/293) on Windows.
    ...
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
        ${pages
          .map((page) => {
            ...
            return `
              <url>
                  <loc>${`https://arifin.xyz${route}`}</loc>
              </url>
            `;
          })
          .join('')}
