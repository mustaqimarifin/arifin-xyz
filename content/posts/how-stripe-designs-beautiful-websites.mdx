...
<Image
  alt={`Stripe Website`}
  src={`/how-stripe-designs-beautiful-websites/website.webp`}
  width={2248}
  height={1590}
/>
...
<Image
  alt={`Camphor Font`}
  src={`/how-stripe-designs-beautiful-websites/camphor.webp`}
  width={1000}
  height={1114}
/>
...
<Image
  ...
  src={`/how-stripe-designs-beautiful-websites/typography.webp`}
  width={1162}
  height={944}
/>
...
<Image
  alt={`CSS Example`}
  src={`/how-stripe-designs-beautiful-websites/css-example.gif`}
  width={1136}
  height={898}
/>
...
<Image
  alt={`Buttons Example`}
  src={`/how-stripe-designs-beautiful-websites/buttons.gif`}
  width={980}
  height={288}
/>
...
<Image
  alt={`Color Palette`}
  src={`/how-stripe-designs-beautiful-websites/color-palette.webp`}
  width={1110}
  height={275}
/>
...
Something else that really stuck out to me was how high quality their images looked. This is because they use SVG ([Scalable Vector Graphic](https://svgontheweb.com/)) images instead of normal `.webp` or `.webp` files whenever possible. This has a multitude of benefits.
...
<Image
  alt={`SVG Example`}
  src={`/how-stripe-designs-beautiful-websites/salesforce.svg`}
  width={420 * 2}
  height={338 * 2}
/>
...
<Image
  ...
  src={`/how-stripe-designs-beautiful-websites/spinning-animation.gif`}
  width={1170}
  height={418}
/>
...
<Image
  ...
  src={`/how-stripe-designs-beautiful-websites/animation-example.gif`}
  width={2198}
  height={358}
/>
