...
A few weeks ago, I [moved this site](https://github.com/leerob/arifin.xyz/pull/326) from using [Firebase](/blog/real-time-post-views) and [Redis](/blog/serverless-redis-nextjs) to PlanetScale. [PlanetScale](https://planetscale.com) is a serverless database platform built on MySQL and Vitess. Here's why I picked PlanetScale:
...
- **Connectionless:** Since PlanetScale is serverless, it's built to withstand thousands of simultaneous connections. You can almost consider this _connectionless_ – the developer doesn't need to worry about [pooling or other common objections](https://twitter.com/vmprmyth/status/1430177168307412998).
...
- Export JSON data from my Firebase Realtime Database
  ...
  <Image
    ...
    src={`/images/mysql-planetscale/firebase.webp`}
    width={2905 / 2}
    height={1959 / 2}
  />
...
- Export JSON data from my Redis cluster using `HVALS` and TablePlus
  ...
  <Image
    ...
    src={`/images/mysql-planetscale/redis.webp`}
    width={2540 / 2}
    height={1852 / 2}
  />
...
<Image
  ...
  src={`/images/mysql-planetscale/checkly.webp`}
  width={1490}
  height={528}
/>
...
<Image
  ...
  src={`/images/mysql-planetscale/checkly-firebase.webp`}
  width={2264 / 2}
  height={1076 / 2}
/>
