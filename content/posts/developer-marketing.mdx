...
5. Create a [developer experience so good](https://arifin.xyz/blog/developer-experience-examples) that it does marketing for you. Write docs worth sharing, filled with helpful diagrams and detailed descriptions. Create code examples and templates that help developers get started quickly.
...
src={`/images/developer-marketing/toy-story.webp`}
width={680 / 1.5}
height={430 / 1.5}
style={{ margin: '0 auto' }}
/>
