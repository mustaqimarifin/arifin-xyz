...
<Image
  alt="Heroku's landing page in 2011 after expanding past Ruby to become a cloud application platform"
  src={`/images/heroku/platform.webp`}
  width={1141}
  height={602}
/>
...
And that's all for now. Hopefully you now have a better appreciation how Heroku changed the software industry. If you see anything missing here about the story of Heroku, [let me know](https://twitter.com/vmprmyth).
