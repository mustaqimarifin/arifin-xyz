...
<Image
  ...
  src={`/images/image-gallery-supabase-tailwind-nextjs/swag.webp`}
  width={2812 / 2}
  height={2140 / 2}
  priority
/>
...
function Image() {
  return (
    <a href="#" className="group">
      ...
      <h3 className="mt-4 text-sm text-gray-700">Mustaqim Arifin</h3>
      <p className="mt-1 text-lg font-medium text-gray-900">@vmprmyth</p>
    </a>
  );
}
```
...
<Image
  alt={`Example of the image gallery`}
  src={`/images/image-gallery-supabase-tailwind-nextjs/supabase.webp`}
  width={2900 / 2}
  height={2228 / 2}
/>
