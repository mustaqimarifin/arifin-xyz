...
<Image
  ...
  src={`/loading-placeholder-with-sass/example.gif`}
  width={695}
  height={419}
  unoptimized
  priority
...
<Image
  ...
  src={`/loading-placeholder-with-sass/facebook.webp`}
  width={1045}
  height={680}
/>
...
<Image
  ...
  src={`/loading-placeholder-with-sass/linkedin.webp`}
  width={1618}
  height={1126}
/>
...
<Image
  ...
  src={`/loading-placeholder-with-sass/final-result.gif`}
  width={650}
  height={223}
  unoptimized
/>
