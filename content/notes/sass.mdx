...
![Loading Placeholder](/sass/example.webp)
...
![Loading Placeholder](/sass/final-result.webp)

You can view the code and a live example on [CodePen](https://codepen.io/mustaqimarifin/pen/XzRzpb?editors=1100). There's also a React library called [react-placeholder](https://github.com/buildo/react-placeholder) that achieves the same effect.
