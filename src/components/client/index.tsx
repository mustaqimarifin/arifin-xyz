...
export const Avatar: FC<AvatarProps> = ({
  ...
  return (
    <div
      {...otherProps}
      className={cx(size === 'sm' ? 'h-6 w-6' : 'h-10 w-10', 'bg-alpha-10 relative inline-block overflow-hidden rounded-full', className)}>
      {src && <img className="h-full w-full rounded-full object-cover" src={src} alt="" width={24} height={24} />}
