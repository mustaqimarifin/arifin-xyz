...
export default function Page() {
	return (
		<>
			<section>
				<div className=" bg-wrap   dark:invert">
					<svg width={700} height={900} role="img" aria-label="Linear logo">
       ...
       // width={ 800 }
        ...
        sizes="100vw" /> */}
				...
				{/*         <div className="my-8 columns-2 z-10 gap-4 sm:columns-3">
          ...
          <div className="relative h-80">
            <Image
              ...
              className="rounded-lg object-cover" />
				...
				<div className="text-4xl te">
					<h1>WORK</h1>
				</div>
				<div className="my-8 text-3xl flex w-full flex-col space-x-0 space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
					𝖆𝖗𝖎𝖋𝖎𝖓
					{/* <ChannelLink
            img={ avatar }
            name="@akhyla"
            link="https://www.youtube.com/@akhyla9848" /> */}
				...
				<div className="prose prose-neutral dark:prose-invert">
					<p>
						Over the past decade, I've written content on my blog and newsletter. I try to keep things simple. You'll
						find writing about technologies I'm interested in at the time, or how I'm learning and growing in my career,
      ...
      <BlogLink name="The Story of Heroku" slug="heroku" />
				...
				<div className="prose prose-neutral dark:prose-invert">
					<p>
						I've worked with and advised companies on <Link href="/notes/developer-marketing">developer marketing</Link>
						, <Link href="/notes/devrel-at-vercel">developer relations</Link>, building open-source communities,
						product-led growth, and more.
					</p>
				</div>
